...
#    Updated: 2017/11/13 13:11:07 by pdespres         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c \
	  ...
	  ft_strlcat.c ft_lstnew.c ft_lstdelone.c ft_lstdel.c \
	  ft_lstadd.c ft_lstiter.c ft_lstmap.c \
	  ft_islower.c ft_isupper.c ft_read.c ft_convert_base.c \
	  ft_countwords.c ft_freetabmem.c
SRCO = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	   ...
	   ft_strjoin.o ft_strlen.o ft_strmap.o ft_strmapi.o ft_strncat.o \
	   ...
	   ft_tolower.o ft_toupper.o ft_strlcat.o ft_lstnew.o ft_lstdelone.o \
	   ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o \
	  ft_islower.o ft_isupper.o ft_read.o ft_convert_base.o \
	  ft_countwords.o ft_freetabmem.o
